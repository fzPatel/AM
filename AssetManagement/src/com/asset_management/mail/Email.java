...
//	      String msg="Welcome at out site and your user id="+userid1+", password="+password1+", designation="+designation1;
	      ...
	      String msg="Welcome at Asset Managment and your user id="+userid+", password="+pwd+", Designation="+designation+" Click here to Login =http://192.168.2.128:8081/AssetManagement/";
	...
	public void forgetpassword(int userid,String pass,String email )
	{
...
//	      String msg="Welcome at out site and your user id="+userid1+", password="+password1+", designation="+designation1;
	      // Sender's email ID needs to be mentioned
	      String msg="Forget Password your user id is ="+userid+",Your is password is = "+pass+" Click here to login http://localhost:8081/AssetManagement/";
	      String from = "wkhan0419@gmail.com";
	      final String username = "wkhan0419@gmail.com";//change accordingly
	      final String password ="10kamilk";//change accordingly
	     // final String designation=designation1;
