...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right top-nav">
            <li><a href="" data-placement="bottom" data-toggle="tooltip" ><i class="fa fa-fw fa-user"></i>
                </a>
            </li>            
            <li class="dropdown">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                ...
                <h4>Employee ID ${user_session}</h4>
                </div>
            </div>
            <!-- /.row -->
        </div>
...
<tr id="oldpasswordId">
<td>
Old Password:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <input type="password" id="oldpassword" name="oldpassword" placeholder="Enter Old Password" required/>
</td>
<div id="mid"></div>
</tr>
...
<tr id="newpasswordId">
<td>
New Password:    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="password" name="password" id="newpassword" placeholder="Enter New Password" required/>
</td>
</tr>  
</br>
...
<td>
Conform Password: <input type="password" name="password2"  placeholder="Conform Password" required/>
</td>
</tr>
</br>
