...
<form name="f1" action="./supportpasswordchanged" onsubmit="return matchpass()" method="post">
		 <table>	
			<tr id="oldpasswordId">
				...
				<td><font color="red"><div id="printmsg"></div></font></td>
			</tr>
			 	<input type="hidden" name="user_designation" value="${user_designation}"/>
			<tr id="newpassword">
				<td>New Password:</td><td><input type="password" name="password" id="newpassword1" placeholder="Enter New Password" required/></td>
			</tr>  
			<tr id="conformpassword">
				<td>Confirm Password:</td><td><input type="password" name="password2"  id="conformpassword1" placeholder="Confirm Password" required/></td>
			</tr>
			
			
			<tr><td></td><td><input type="submit" id="btnSubmit" name="submit" value="ok"/><button type="button" onClick="window.location.reload();">Refresh</button></td></tr>
		  </table>
