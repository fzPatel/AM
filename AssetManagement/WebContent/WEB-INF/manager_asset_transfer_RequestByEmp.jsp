        ...
        <ul class="nav navbar-right top-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="./updateprofiletojsp"><i class="fa fa-fw fa-user"></i> Edit Profile</a></li>
...
%>	
<table border="1">
<tr><th>TranferId</th><th>AssetID</th><th>Asset Name</th><th>From EmployeeId</th><th>To EmployeeId</th><th>Transfer Request Date</th><th>Status</th><th>Action</th></tr>
...
<% 
										...
										{
										%>									
											<td><h5> <font color="Orange">Pending by Request from Manager</font></h5></td>
										<%
										}
										else if(ub.getTransferstatus()==0)
										{%>									
											<td><h5> <font color="Green">Approved by Request from Manager</font></h5></td>
										<%}
										else if(ub.getTransferstatus()==1)
										{%>									
											<td><h5><font color="Red">Rejected by Request from Manager</font></h5></td>
										...
										{%>									
										<td><h5><font color="Red">Pending by your Employee</font></h5></td>
										...
										{%>									
										<td><h5><font color="Green">Approved your request by your Employee</font></h5></td>
										
										<%}

										else if(ub.getTransferstatus()==7)
									{%>									
									<td><h5><font color="Red">Rejected Your request by your Employee</font></h5></td>
									
								<%}
%>

<td colspan="2" id="aprovebtn">
				<form action="./aprooveAssetTransferEmprequest" method="post">
				
				
			  <input type="hidden" name="fromempid" value="<%=ub.getFromempid()%>"/>
			<input type="hidden" name="toempid" value="<%=ub.getToempid()%>"/>
			  			<input type="hidden" name="assetid" value="<%=ub.getAssetid()%>"/>
			  
			
				<input type="hidden" name="transferid" value="<%=ub.getTransferid()%>"/>
				<input type="submit" name="submit" value="approve" Onclick="return confirm('Are you sure You want to Approve')"/>												
					</form>
				</td>
				<td>		
			  ...
			  <input type="hidden" name="fromempid" value="<%=ub.getFromempid()%>"/>
				...
				<input type="hidden" name="transferid" value="<%=ub.getTransferid()%>"/>
					...
					<input type="submit" name="submit" value="reject" Onclick="return confirm('Are you sure You want to Reject')"/>												
				</form>
					</td>	
</tr>
<% 
