...
<font color="blue"><h1>${oh}</h1></font>
	...
	<h1><font color="orange">Feed User Form</font></h1>
		...
		<form action="./insertuser" id="form1" method="post">	
			...
			<tr><td>First Name :</td><td><input type="text" name="firstname" id="firstname" pattern="[A-Za-z-]+" title="only alphabet" required/></td></tr>
		...
		<tr id="its">
			...
			<tr id="mobilerow"><td>Mobile :</td><td><input type="text" name="mobile" id="mobile" maxlength="10" title="Enter Mobile Number" pattern="[0-9]{10}" required/></td></tr>
			<tr id="dateofjoiningrow"><td>Date Of Joining :</td><td><input type="date" id="datepicker-12" name="dateofjoining" required/></td></tr>
