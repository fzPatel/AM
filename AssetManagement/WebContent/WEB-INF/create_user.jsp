...
<center>
	...
	<h1><font color="orange">Feed User Form</font></h1>
		...
		<form action="./insertuser" id="form1" method="post">	
			...
			<tr><td>First Name :</td><td><input type="text" name="firstname" id="firstname" placeholder="Enter First Name" required/></td></tr>
			
			<tr><td><font color="red" size="4"><div id="name1"></div></font></td><tr>
			
			<tr><td>Last Name :</td><td><input type="text" name="lastname" id="lastname"  placeholder="Enter last Name"required/></td></tr>
			
			<tr><td><font color="red" size="4"><div id="name2"></div></font></td><tr>
			
			
			<tr><td>E-mail :</td><td><input type="email" name="emailid" id="emailid" placeholder="Enter E-Mailid" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Enter emailid" id="i1" required/></td></tr>
		...
		<tr id="its">
			...
			<tr id="mobilerow"><td>Mobile :</td><td><input type="text" name="mobile" id="mobile" maxlength="10" title="Enter Valid Mobile Number" pattern="[0-9]{10}" required/></td></tr>
